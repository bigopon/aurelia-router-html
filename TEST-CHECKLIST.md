...
- [x] `A7` Hash scrolling checks literal and decoded IDs before legacy anchor names, handles `#top`, cancels stale requests, and waits for asynchronous route activation.
